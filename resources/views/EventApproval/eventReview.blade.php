                    ...
                    <div class="md:w-1/2 p-6">
                        ...
                        <div class="mb-4">
                            ...
                            @if ($event->status === 'pending')
                                <span
                                    class="inline-block px-3 py-1 rounded-full text-sm font-medium bg-yellow-100 text-yellow-800">
                                    Pending Review
                                </span>
                    ...
                    <form id="reviewForm" action="{{ route('event.review', $event->id) }}" method="POST">
                        ...
                        <div class="mb-6">
                            ...
                            <div class="flex space-x-4">
                                <label class="flex items-center">
                                    <input type="radio" name="action" value="approve" class="sr-only"
                                        onchange="toggleReviewSection()">
                                    <div
                                        class="review-option bg-green-50 border-2 border-green-200 rounded-lg p-4 cursor-pointer hover:bg-green-100 transition-colors duration-200">
                                ...
                                <label class="flex items-center">
                                    <input type="radio" name="action" value="reject" class="sr-only"
                                        onchange="toggleReviewSection()">
                                    <div
                                        class="review-option bg-red-50 border-2 border-red-200 rounded-lg p-4 cursor-pointer hover:bg-red-100 transition-colors duration-200">
                                        <div class="flex items-center">
                                            <div class="flex-shrink-0">
                        ...
                        <div id="reviewSection" class="hidden mb-6">
                            ...
                            <p class="mt-1 text-xs text-gray-500">
                                Be specific and constructive in your feedback to help the event organizer improve their
                                submission.
                            </p>
                        </div>
                        ...
                        <div id="approvalCommentSection" class="hidden mb-6">
                            ...
                            <textarea name="approval_comment" id="approval_comment" rows="3"
                                class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                        ...
                        @foreach ($event->reviews as $review)
                            <div class="border-l-4 border-gray-200 pl-4">
                                <div class="flex justify-between items-start mb-2">
                                    <span
                                        class="text-sm font-medium text-gray-900">{{ $review->user->name ?? 'Admin' }}</span>
                                    <span
                                        class="text-xs text-gray-500">{{ \Carbon\Carbon::parse($review->created_at)->format('M d, Y \a\t g:i A') }}</span>
                                </div>
