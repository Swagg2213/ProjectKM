                ...
                @foreach ($topEvents as $event)
                    <div class="flex-shrink-0 w-80">
                        <a href="{{ route('event.detail', $event->id) }}">
                            <div class="bg-white rounded-lg shadow-lg overflow-hidden hover:shadow-xl transition-shadow duration-300 relative h-full flex flex-col">
                                <div class="relative">
                                ...
                                <div class="p-4 flex-grow flex flex-col">
                                    ...
                                    <div class="flex justify-between items-center text-sm text-gray-500 mt-auto">
                                        ...
                                        <span class="flex items-center">
                                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" class="w-4 h-4 text-yellow-400 mr-1">
                                                <path fill-rule="evenodd" d="M10.868 2.884c-.321-.772-1.415-.772-1.736 0l-1.83 4.401-4.753.381c-.833.067-1.171 1.107-.536 1.651l3.62 3.102-1.106 4.637c-.194.813.691 1.456 1.405 1.02L10 15.591l4.069 2.485c.713.436 1.598-.207 1.404-1.02l-1.106-4.637 3.62-3.102c.635-.544.297-1.584-.536-1.65l-4.752-.382-1.831-4.401Z" clip-rule="evenodd" />
                                            </svg>
    ...
    <div class="container mx-auto px-4 py-8">
        ...
        @if ($events->isEmpty())
            <div class="bg-white rounded-lg shadow-sm p-12 text-center text-gray-500">
                ...
                <p class="mt-1 text-sm text-gray-500">There are no events matching your search criteria. Try a different search!</p>
            </div>
        @else
