...
@section('content')
                        ...
                        <div class="bg-white rounded-lg shadow-lg overflow-hidden">
                            ...
                            <div class="p-6 space-y-4">
                                <div class="flex items-start">
                                    ...
                                    <div class="flex-1 min-w-0">
                                        ...
                                        <p class="text-sm text-gray-600 truncate">
                                            ...
                                            {{ \Carbon\Carbon::parse($event->endTime)->format('g:i A') }}</p>
                                    </div>
                                </div>
                                ...
                                @php
                                    ...
                                    $link = Str::startsWith($event->link, ['http://', 'https://'])
                                        ? $event->link
                                        : 'https://' . $event->link;
                                @endphp
                                <a href="{{ $link }}" target="_blank"
                                    class="w-full flex items-center justify-center px-6 py-3 border border-transparent rounded-md shadow-sm text-base font-medium text-white bg-orange-500 hover:bg-orange-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-orange-500 transition-transform hover:scale-105">
                                    Register Now
                                </a>
                                ...
                                <form action="{{ route('event.toggleFavorite', $event->id) }}" method="POST">
                                    @csrf
                                    <button type="submit"
                                        class="w-full flex items-center justify-center px-6 py-3 border border-gray-300 rounded-md shadow-sm text-base font-medium text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-orange-500">
                                        ...
                                        @else
                                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                                stroke-width="1.5" stroke="currentColor" class="w-5 h-5 mr-2 text-gray-400">
    ...
    <a href="#top"
        class="fixed bottom-4 right-4 p-3 z-10 border-2 border-gray-300 bg-white hover:bg-gray-100 rounded-full shadow-lg">
